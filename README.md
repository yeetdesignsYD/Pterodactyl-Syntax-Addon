...
go to `/var/www/pterodactyl/node_modules/codemirror/mode/jsx` and replace `jsx.js` with the `jsx.js` within <a href="/node_modules/codemirror/mode">`/node_modules/codemirror/mode`</a>
